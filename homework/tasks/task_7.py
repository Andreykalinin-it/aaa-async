...
class Handler:
    ...
    async def handle_request(self) -> None:
        # Модель выполняет некий тяжёлый код
        # (ознакомьтесь с ним в файле тестов),
        ...
        # не слишком сильно отличается от времени исполнения нескольких
        # таких корутин, запущенных конкурентно.
        #
        # YOU CODE GOES HERE
